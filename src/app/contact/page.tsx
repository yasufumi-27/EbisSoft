          ...
          <div className="grid gap-8 lg:grid-cols-3">
            ...
            <aside className="space-y-5 lg:sticky lg:top-24 lg:self-start" data-reveal>
              <div className="panel panel-corners p-6">
                ...
                >
                  <span className="grid size-10 shrink-0 place-items-center rounded-lg border border-white/15 bg-white/5 transition-all group-hover:border-brand/50 group-hover:shadow-[0_0_16px_rgba(34,211,238,0.3)]">
