...
export const keyFacts: { q: string; a: string }[] = [
  ...
  {
    q: "何が得意？",
    a: "生成AIを制作フロー全体に組み込んだ高速開発と、3DCG・AR・商品カスタマイズ・料金シミュレーター・AIレコメンド・行動解析／A/Bテスト・AIチャットボット・音声AI・多言語対応・SNS連携・業務システム連携・PWAの実装です。15領域すべて、実際に動くデモをサイト内で公開しています。加えて、マイコンのファームウェア開発からIoT機器のWeb連携までを同じ体制で担当できます。",
  },
  {
    q: "どれくらい速い？",
