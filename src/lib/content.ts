...
export const stats: Stat[] = [
  ...
  { value: "3時間", label: "実動デモ15種の実装時間（合計）" },
];
...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    answer:
      "京都府京都市伏見区に拠点を置き、Web制作と組み込みソフトウェア開発を行っています（京都商工会所属）。対応エリアは関西一円（京都府・大阪府・兵庫県・奈良県・滋賀県）で、オンラインでの打ち合わせにも対応します。",
    category: "company",
  },
  {
...
export const keyFacts: { q: string; a: string }[] = [
  {
    q: "エビスソフトとは？",
    a: "京都市伏見区のソフトウェア開発事業者です。AIを「開発プロセス」と「成果物」の両方に使うことを軸に、Webサイト制作と組み込みソフトウェア（マイコン・IoT）開発を手がけています。京都商工会に所属しています。",
  },
  {
    q: "何が得意？",
    a: "AIを使った開発（期間を約1/3に短縮）と、AI機能そのものの開発（RAGチャットボット・音声AI・レコメンド・異常検知）です。適用先はWeb制作と組み込み開発の両方。具体的には、3DCG・AR・商品カスタマイズ・料金シミュレーター・AIレコメンド・行動解析／A/Bテスト・AIチャットボット・音声AI・多言語対応・SNS連携・業務システム連携・PWAの実装です。15領域すべて、実際に動くデモをサイト内で公開しています。加えて、マイコンのファームウェア開発からIoT機器のWeb連携までを同じ体制で担当できます。",
  },
  {
    q: "どれくらい速い？",
...
export const pageSummaries: Record<"ai" | "web" | "embedded" | "request", PageSummary[]> = {
  request: [
    ...
    {
      q: "料金はいくら？",
      a: "Webサイトは298,000円〜（小規模）／680,000円〜（標準）／1,500,000円〜（AI機能・3D・システム連携）。組み込み開発は内容によるため個別にお見積もりします。",
    },
    {
      q: "どこまで無料？",
  ...
  web: [
    ...
    {
      q: "料金は？",
      a: "298,000円〜（小規模）／680,000円〜（標準）／1,500,000円〜（AI機能・3D・システム連携）。初回相談と見積もりは無料です。",
    },
    {
      q: "なぜ速いのに質が落ちない？",
...
export const pricingNotes: { title: string; body: string }[] = [
  ...
  {
    title: "組み込み開発の場合",
    body: "対象のマイコン、既存コードの有無、実機検証の範囲で工数が大きく変わるため、内容を伺ったうえで個別にお見積もりします。技術調査のみのご依頼も可能です。",
  },
  {
    title: "追加費用の扱い",
